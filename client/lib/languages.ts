...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    uploadToGetAnalysis: 'Upload a photo of your teeth to get instant AI-powered analysis with accuracy metrics',
    ...
    healthScoreGood: 'Your dental health looks good. Continue with preventive care.',
    healthScoreCaution: 'Some issues detected. We recommend consulting a dentist soon.',
    healthScoreCritical: 'Urgent attention required. Please consult a dentist immediately.',
    reAssess: 'Re-assess',

    // Doctors
    findCompare: 'Find & Compare Dentists',
    findBestDentist: 'Find the best dentist near you with ratings, pricing, and real patient reviews',
    ...
    fastReliable: 'Fast, reliable ambulance services for dental emergencies. Real-time tracking and transparent pricing.',
    ...
    trackDentalJourney: 'Track your dental health journey with detailed reports and recommendations',
  ...
  hi: {
    ...
    uploadToGetAnalysis: 'तत्काल एआई-संचालित विश्लेषण के लिए अपने दांतों की फोटो अपलोड करें',
    ...
    healthScoreCaution: 'कुछ स��स्याएं पाई गईं। हम शीघ्र ही दंत चिकित्सक से परामर्श लेने की अनुशंसा करते हैं।',
    healthScoreCritical: 'तत्काल ध्यान आवश्यक है। कृपया तुरंत दंत चिकित्सक से परामर्श लें।',
    reAssess: 'पुनः मूल्यांकन करें',

    findCompare: 'दंत चिकित्सकों को खोजें और तुलना करें',
    findBestDentist: 'रेटिंग, मूल्य और वास्तविक रोगी समीक्षाओं के साथ आपके पास सर्वश्रेष्ठ दंत चिकित्सक खोजें',
    ...
    fastReliable: 'दंत आपातकाल के लिए तेज और विश्वसनीय एम्बुलेंस सेवा। वास्तविक समय ट्रैकिंग और पारदर्शी मूल्य निर्धारण।',
    ...
    trackDentalJourney: 'विस्तृत रिपोर्ट और सिफारिशों के साथ अपनी दंत स्वास्थ्य यात्रा को ट्रैक करें',
    ...
    failedFetchModel: 'मॉडल की जानकारी प्राप्त करने में विफल। डेमो मोड का उपयोग कर रहे हैं।',
